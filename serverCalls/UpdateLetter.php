<?php 
        ...
        $sql1 = "UPDATE matter_letters SET FileNumber='$FileNumber', SubjectLine='$SubjectLine', IsCharged='$isCharged', PersonAttended='$AttendingPerson', Date='$Date', ToOrFrom='$ToOrFrom', Sent='$Sent', Received ='$Received' WHERE ID='$ID'";
        mysqli_query($con, $sql1); 

        $sql ="UPDATE scheduleofwork SET FileNumber='$FileNumber', Date='$Date', ToOrFrom='$ToOrFrom', Sent='$Sent',Description='$SubjectLine', Units='$Unit', Amount='$Amount', StartTime='$Time' WHERE ID='$ID' AND TypeOfWork='L'";
