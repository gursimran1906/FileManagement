...
$sql =  "INSERT INTO ledger_accounts_transfers (FileNumberFrom, FileNumberTo, FromLedgerAccount,ToLedgerAccount, Amount, Date, Description) 
    
        VALUES ('$FileNumberFrom','$FileNumberTo','$FromLedgerAcc','$ToLedgerAcc','$Amount','$Date','$Description')";
