...
$ID = $_REQUEST['ID'];
$sql = $sql = "SELECT * FROM matter_emails WHERE ID = '$ID' LIMIT 1";
...
<body class="d-flex flex-column min-vh-100">
  ...
  <div class="container">
    <form class="row g-3" action="serverCalls/EditEmails.php" method="post" id="AddEmailForm">
      <div class="col-md-8">
      ...
      <div class="col-md-6">
        ...
        <input required type="time" class="form-control" name="Time" value="<?php
