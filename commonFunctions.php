    ...
    <nav class="  d-flex flex-row bg-light">
            ...
            <div class="d-flex justify-content-end highlight mb-3">
                <a class="p-2 " href="index.php" style="background-color: transparent !important;">
                    <img src="images/ANP_New_Logo.png" alt="ANP Logo" width="200" height="75" >
                </a>
...
function sessionCheck()
{
    ...
    function logOut() {
        ...
        window.location.href = 'Logout.php?URL=' + encodeURIComponent(currentURL);
    }
    ...
    window.onbeforeunload = function() { 
        ...
        window.setTimeout(function () { 
            logOut();
           // window.location = 'Logout.php?URL=window.location.href';
        }, 0); 
...
function initialsList($con, $selected, $showNewRate)
{
    ...
    $sql = 'SELECT * from users ORDER BY userInitials ASC';
    $data = $con->query($sql);
